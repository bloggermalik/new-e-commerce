      ...
      <DropdownMenuTrigger asChild>
        <div className="group flex items-center cursor-pointer gap-2 !ml-0 mr-2 md:mr-2">
          <Avatar className="w-10 h-10">
            ...
            <AvatarFallback className="bg-primary border border-white border-2 text-white font-semibold">
      ...
      >
        <div className="flex flex-col items-center space-y-3 px-2  border-b ">
          ...
          {session?.user?.role === "admin" && (
            <span className="text-xs text-muted-foreground capitalize -mt-4 ">
          ...
          <Link
            href="/orders"
            className="max-w-xl w-[220px] cursor-pointer hidden md:block"
          >
            <DropdownMenuItem asChild>
              <Button
                variant="outline"
          ...
          <Link
            href="/profile"
            className="max-w-xl w-[220px]  cursor-pointer mb-3"
          >
            <DropdownMenuItem asChild>
              <Button
                variant="outline"
                size="sm"
                className="w-full border  h-11  
                            focus-visible:ring-0 focus-visible:ring-offset-0
            ...
            >
              <DropdownMenuItem asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="w-full border  h-11  cursor-pointer rounded-full
            hover:border-primary hover:translate-x-0.5 !transition-all duration-300 ease-in-out"
                >
