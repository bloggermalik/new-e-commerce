...
export async function SiteHeader() {
  ...
  return (
    <header className=" bg-primary flex text-white h-18 md:h-20 shrink-0 items-center border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
