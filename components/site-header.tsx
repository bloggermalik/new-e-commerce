...
export async function SiteHeader() {
  ...
  return (
    <header className=" bg-background-header flex h-14 md:h-20 shrink-0 items-center border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
